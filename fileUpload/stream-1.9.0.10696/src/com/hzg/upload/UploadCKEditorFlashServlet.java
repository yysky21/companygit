 ...
 */
public class UploadCKEditorFlashServlet extends HttpServlet {

    private static long fileSizeMax = 1024*1024*100;
    private static long sizeMax = 1024*1024*1000;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(Configurations.getConfig("ckEditorFlashUpload_CROSS_ORIGIN")+"?flashUrl="+ Configurations.getConfig("flashServerUrl") + "/" + filePath.replace(baseDir+File.separator, "").replace(File.separator, "/") + "&message=" + message + "&CKEditorFuncNum=" + request.getParameter("CKEditorFuncNum"));
    }
