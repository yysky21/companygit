 ...
 */
public class UploadCKEditorImageServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(Configurations.getConfig("ckEditorImageUpload_CROSS_ORIGIN")+"?imageUrl="+ Configurations.getConfig("imageServerUrl") + "/" + filePath.replace(baseDir+File.separator, "").replace(File.separator, "/") + "&message=" + message + "&CKEditorFuncNum=" + request.getParameter("CKEditorFuncNum"));
    }
