...
public class ErpConstant {
    ...
    public final static Integer product_state_onRepairProduct = 86;
    ...
    public final static Integer supplier_state_valid = 0;
    public final static Integer supplier_state_cancel = 1;
    ...
    public final static String borrowProduct = "borrowProduct";
    public final static String borrowProductReturn = "borrowProductReturn";

    public final static Integer borrowProduct_state_save = 0;
    public final static Integer borrowProduct_state_apply = 1;
    public final static Integer borrowProduct_state_complete = 2;
    public final static Integer borrowProduct_state_cancel = 3;
    public final static Integer borrowProduct_state_returned = 4;
    ...
    public final static Integer borrowProductReturn_state_save = 0;
    public final static Integer borrowProductReturn_state_apply = 1;
    public final static Integer borrowProductReturn_state_complete = 2;
    public final static Integer borrowProductReturn_state_cancel = 3;

    public final static String borrowProduct_action_name_apply = "applyBorrowProduct";
    public final static String borrowProduct_action_name_warehousingAudit = "borrowProductWarehousingAudit";
    public final static String borrowProductReturn_action_name_apply = "applyBorrowProductReturn";
    public final static String borrowProductReturn_action_name_warehousingAudit = "borrowProductReturnWarehousingAudit";

    public final static Integer borrowProduct_action_warehousingAudit_pass = 0;
