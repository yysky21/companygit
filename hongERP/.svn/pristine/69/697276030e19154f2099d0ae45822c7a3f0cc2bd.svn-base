...
// Source File Name:   SailOrderStatusQueryResponseStep.java

package com.sf.openapi.express.sample.wms.salesOrder.dto;

import com.sf.openapi.common.entity.BaseEntity;

public class SailOrderStatusQueryResponseStep extends BaseEntity
{

    public SailOrderStatusQueryResponseStep()
    {
    }
