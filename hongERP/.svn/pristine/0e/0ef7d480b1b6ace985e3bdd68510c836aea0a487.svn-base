...
// Source File Name:   SailOrderQueryResponseContainer.java
...
public class SailOrderQueryResponseContainer extends BaseEntity
{

    public SailOrderQueryResponseContainer()
    {
    }
