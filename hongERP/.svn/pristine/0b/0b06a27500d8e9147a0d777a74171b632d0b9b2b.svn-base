...
// Source File Name:   SailOrderInvoiceDetail.java

package com.sf.openapi.express.sample.wms.salesOrder.dto;

import com.sf.openapi.common.entity.BaseEntity;

public class SailOrderInvoiceDetail extends BaseEntity
{

    public SailOrderInvoiceDetail()
    {
    }
    ...
    private static final long serialVersionUID = 0xdcff21bf4c59db1eL;
