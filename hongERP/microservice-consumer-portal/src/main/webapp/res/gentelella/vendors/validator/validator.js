    ...
    */
    mark = function( field, text ){
        ...
        if( item.hasClass(defaults.classes.bad) ){
            ...
            if (document.getElementById("alert"+field.attr("id")) == null) {
                warning = $('<div class="'+ defaults.classes.alert +'" id="alert' + field.attr("id") + '">').html( text );
                item.append( warning );
            }
    ...
    */
    function checkAll( $form ){
        ...
        var that = this,
            ...
            fieldsToCheck = $form.find(':input').filter('[required=required], .required, .optional');
