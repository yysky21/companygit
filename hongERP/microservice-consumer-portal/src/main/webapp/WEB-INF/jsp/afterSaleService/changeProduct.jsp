                ...
                <div class="x_panel">
                        ...
                        <div class="item form-group" style="margin-top:20px;">
                            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 150px;margin-top: 10px">
                                <form id="actionForm">
                                    ...
                                    <input type="hidden" name="entity"  value="<%=ChangeProduct.class.getSimpleName()%>">
                    ...
                    <c:if test="${fn:contains(resources, '/afterSaleService/doBusiness/returnProductWarehousingAudit') && entity.state == 51}">
                        <form id="printForm" method="post" action="<%=request.getContextPath()%><%=AfterSaleServiceConstant.privilege_resource_uri_print_expressWaybill%>" target="_blank">
                            <input type="hidden" name="json" value='{"entity":"<%=ChangeProduct.class.getSimpleName()%>","entityId":${entity.id},"sessionId":"${sessionId}"}'>
                        </form>
                    </c:if>
                    ...
                    <div class="x_content">
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-12 col-md-offset-1" id="submitDiv">
                                ...
                                <button id="printExpress" type="button" class="btn btn-success" style="display: none">打印退货快递单</button>
        ...
        <c:if test="${entity.state == 4}">
            <c:if test="${fn:contains(resources, '/afterSaleService/doBusiness/changeProductWarehousingAudit')}">
                ...
                $("#warehousingAuditNotPass").click(function(){
                    $("#auditResult").val('N');
                    $("#actionForm").submitForm('<%=request.getContextPath()%>/afterSaleService/doBusiness/returnProductWarehousingAudit', function(result){
