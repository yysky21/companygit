...
var lightboxm = (function($) {
	 ...
	 */
    function initialize_lightbox(options) {
        // build main options
	...
	var defaults = {
	  triggerEvent: "click",
		allSet: false,
		fileLoadingImage: '../../res/images/loading.gif',
		fileBottomNavCloseImage: '../../res/images/close.gif',
		overlayOpacity: 0.6,
		borderSize: 10,
	...
	return {
		initialize : initialize_lightbox,
