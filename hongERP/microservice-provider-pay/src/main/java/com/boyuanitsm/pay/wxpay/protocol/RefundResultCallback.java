package com.boyuanitsm.pay.wxpay.protocol;

/**
 * 微信退款结果通知
 * https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_16&index=10
 * @Date 2017/9/29
 */
public class RefundResultCallback {
